...
extern void I2C_Write_Multiple(uint8_t slave_address , uint8_t *data , uint32_t num_of_data);
...
extern void I2C_Read_Multiple(uint8_t slave_address , uint8_t *data , uint32_t num_of_data);
extern void I2C_Read_Memory_Multiple(uint8_t slave_address , uint8_t slave_memory_address , uint8_t *data , uint32_t num_of_data);
