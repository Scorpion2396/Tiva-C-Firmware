...
extern void I2C_Write_Multiple(uint8_t slave_address , char *data , uint8_t num_of_data);
...
extern void I2C_Read_Multiple(uint8_t slave_address , char *data , uint8_t num_of_data);
extern int I2C_Read_Memory(uint8_t slave_address , uint8_t slave_memory_address);
extern void I2C_Read_Memory_Multiple(uint8_t slave_address , uint8_t slave_memory_address , char *data , uint8_t num_of_data);
